...
//		carArray[0].driveMaxSpeed(); //컴파일상 코드작성상 문제는 없으나 런타임시 NullPointerException 발생
...
//		carArray[5] = new Car("해리포터", 1000); //컴파일상 코드작성상 문제는 없으나 런타임시 ArrayIndexOutOrBoundsException 발생
